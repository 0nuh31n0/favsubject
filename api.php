...
switch ($t) {
    case 'topic1':
        $url = 'https://tund.tak17nurmberg.itmajakas.ee';
    ...
    case 'topic3':
        ...
        break;
    default:
        $url = 'https://fav.tak17mei.itmajakas.ee?limit=3';
...
<div class="container">
    <div align="right">
        <a href="https://fav.tak17mei.itmajakas.ee">API</a>
        <a>│</a>
        <a href="https://fav.tak17mei.itmajakas.ee/form.php">Form</a>
    </div>
    <div class="col-4">
        <ul>
